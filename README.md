...
<div align="center">
<h1> <b> Ruby group capstone - Catalog of my things</b> <hr/>
...
```sh
  cd my-folder
  git clone git@github.com:ZewdieMc/catalog-of-my-things.git (SSH)
```
...
Feel free to check the [issues page](https://github.com/ZewdieMc/catalog-of-my-things/issues).
